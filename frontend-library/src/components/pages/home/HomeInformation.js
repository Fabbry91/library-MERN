        ...
        <>
            <div className="container my-2">
                ...
                <div className="row align-items-center p-2">
                    ...
                    <div className="col d-flex align-items-center border border-warning rounded-2 me-2">
                        ...
                        <div className="flex-grow-1 ms-3">
                            ...
                            <Link className="h6" data-bs-toggle="modal" data-bs-target="#exampleModal">Ver más...</Link>
                        </div>
                    </div>
                    ...
                    <div className="col d-flex align-items-center border border-warning rounded-2 me-2">
                        ...
                        <div className="flex-grow-1 ms-3">
                            ...
                            <Link className="h6" data-bs-toggle="modal" data-bs-target="#exampleModal">Ver promociones bancarias...</Link>
                        </div>
                    </div>

                    <div className="col d-flex align-items-center border border-warning rounded-2">
                        <div className="flex-shrink-0">
