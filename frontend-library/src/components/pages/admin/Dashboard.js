...
export const Dashboard = () => {
    ...
    return (
        <nav className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark position-fixed">
                ...
                <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li className="nav-item">
                        <Link to="/admin/personas" className="nav-link align-middle px-0">
                            <i className="fs-5 bi-people-fill" /> <span className="ms-1 d-none d-sm-inline">Articulos</span>
                        </Link>
                    </li>
